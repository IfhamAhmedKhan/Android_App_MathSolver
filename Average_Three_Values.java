...
public class Average_Three_Values extends AppCompatActivity {
    EditText editTextNumber3,editTextNumber4,editTextNumber5;
    Button button13;
    TextView textView17;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_average_three_values);
        ...
        button13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int val4 = (val1+val2+val3)/3;
                textView17.setText("Average = "+val4);
            }
        });
    }
}